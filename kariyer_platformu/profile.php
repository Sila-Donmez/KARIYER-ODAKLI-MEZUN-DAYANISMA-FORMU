...
require_once 'includes/functions.php'; // Yorum satırı kaldırıldı, artık merkezi fonksiyonları kullanıyoruz.
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['bio'])) {
    // functions.php içindeki clean() fonksiyonu kullanılıyor
    $bio = clean($_POST['bio'] ?? '');
    ...
    try {
        // Profil tablosunu güncelle veya ekle
        ...
        // Role göre ek tabloları güncelle
        if ($role == 'student') {
        ...
        // Yetenekleri güncelle (Önce siliyoruz, sonra yeni listeyi ekliyoruz)
...
// Yetenekleri virgülle ayrılmış string haline getir
                ...
                <div class="profile-form-area">
                    <div class="glass-card" style="padding: 40px; margin-bottom: 30px;">
                        <?php if (!empty($success_msg)): ?>
                            <div class="alert" style="background: #ECFDF5; border: 1px solid #6EE7B7; color: #047857; padding: 15px; border-radius: 12px; margin-bottom: 20px;">
                                <i class="fa-solid fa-circle-check" style="margin-right: 5px;"></i> <?= $success_msg ?>
                            </div>
                        <?php endif; ?>
                        
                        <?php if (!empty($error_msg)): ?>
                            <div class="alert alert-error" style="background: #FEF2F2; border: 1px solid #FCA5A5; color: #DC2626; padding: 15px; border-radius: 12px; margin-bottom: 20px;">
                        ...
                        <form method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="bio" class="form-control" rows="4" placeholder="Kendinizden veya hedefleri nizden bahsedin..."><?= htmlspecialchars($profile_data['bio']) ?></textarea>
                            </div>
                            ...
                            <?php elseif ($role == 'graduate'): ?>
                                <div class="form-row" style="display: flex; gap: 20px; align-items: flex-end;">
                                    ...
                                    <div class="form-group" style="flex: 1; display: flex; align-items: center; margin-bottom: 20px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="skill-input-group" style="display: flex; gap: 10px;">
                                    <input type="text" id="skill_input" class="form-control" placeholder="Örn: PHP, Java, Yapay Zeka">
                                    <button type="button" id="add_skill_btn" class="btn-add-skill" style="background-color: var(--kbu-lacivert); color: white; border: none; border-radius: 12px; padding: 0 20px; font-weight: 800; cursor: pointer;">Ekle</button>
                                </div>
                    ...
                    <div class="glass-card" style="padding: 40px;">
                        ...
                        <?php if($document_status): ?>
                            <div class="alert" style="background: #e0f2fe; border: 1px solid #bae6fd; color: #0369a1; padding: 15px; border-radius: 12px; margin-bottom: 20px;">
