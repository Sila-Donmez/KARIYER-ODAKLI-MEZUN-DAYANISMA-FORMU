...
// SQL: is_verified bilgisini çekiyoruz
$sql = "SELECT u.first_name, u.last_name, u.email, u.role, u.is_verified, p.bio, p.linkedin_url, p.website_url,
...
if (!$user_data) { die("Veriler bulunamadı."); }
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <div class="card-boxy">
                <div class="header-flex">
                    <div class="avatar-sq">
                        ...
                        <?php if($user_data['is_verified'] == 1): ?>
                            <div class="verified-badge" title="Doğrulanmış Hesap">
                        ...
                        <div class="status-row">
                            ...
                            <?php if($user_data['is_verified'] == 1): ?>
                                <span class="verified-text">
                                    <i class="fa-solid fa-circle-check"></i> Doğrulanmış Profil
                                </span>
                            <?php endif; ?>
                        </div>
                        <h1 class="user-name">
                ...
                <div class="user-bio">
                    <i class="fa-solid fa-quote-left" style="color: #cbd5e1; margin-right: 10px;"></i>
                    <?= !empty($user_data['bio']) ? htmlspecialchars($user_data['bio']) : 'Henüz bir biyografi eklenmemiş. Kendinizi tanıtmak için profili düzenleyin.' ?>
                </div>
                ...
                <div class="link-row">
                    ...
                    <?php if (!empty($user_data['website_url'])): ?>
                        <a href="<?= htmlspecialchars($user_data['website_url']) ?>" target="_blank" class="btn-box pt">
                            <i class="fa-solid fa-globe"></i> Portfolyo
                        </a>
                    <?php endif; ?>
            ...
            <div class="info-grid">
                <div class="card-boxy">
                    <h3 class="card-title"><i class="fa-solid fa-graduation-cap"></i> Eğitim ve İletişim</h3>
                    <div class="data-item">
                    ...
                    <?php elseif ($user_data['role'] == 'graduate'): ?>
                        ...
                        <div class="data-item">
                            ...
                            <p><?= ($user_data['is_open_to_mentorship'] == 1) ? '✅ Mentorluğa Açık' : '❌ Kapalı' ?></p>
                        </div>
                    <?php endif; ?>
                </div>

                <div class="card-boxy">
                    <h3 class="card-title"><i class="fa-solid fa-bolt"></i> Yetkinlikler ve Yetenekler</h3>
                    <div class="skills-flex">
                        ...
                        if (!empty($user_data['yetenekler'])) {
                            ...
                            echo "<p class='empty-text'>Henüz bir yetenek eklemediniz.</p>";
                        }
                        ?>
                    </div>
                </div>
